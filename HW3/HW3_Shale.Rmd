...
**The estimated average treatment effect of smoking on birthweight using the exact matching estimator is `r coe[1,2]` grams, while the comparable linear regression gives an average treatment effect of `r coe[1,1]` grams. These values are quite close.**
