...
DD_1 <- lm(formula = rprice ~ nearinc*year, data=data)
...
```{r}
ci_DD <- starprep(DD_1, stat = c("ci"), se_type = "HC2", alpha = 0.05)
...
**The 95% CI for the estimate in (d) is between `r ci_DD[4,1]` and `r ci_DD[4,2]`. Because this range includes 0 (and because of the p-value of 0.11 in part (d)) this is not statistically significant at the 0.05 level.**
